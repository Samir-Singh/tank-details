...
import style from "./BmpDetails.module.css";
import tank_img from "../../assets/bmp.jpg";
  ...
  return (
    <div className={style.main_div}>
      <div className={style.bread_crum}>
        ...
        {">"}{" "}
        <span className={style.link_bread} onClick={() => navigate("/bmpList")}>
          BMP List
        </span>{" "}
        {">"} Tank Details
      </div>
      ...
      <div className={style.main_details_div}>
        ...
        <div className={style.tank_details_div}>
          <p className={style.tank_code_para}>BMP CODE : ITM-00002</p>
      ...
      <div className={style.tank_details_table_div}>
        ...
        <TankDetailsTable table_heading="BOH TASK DETAILS" />
      </div>
    </div>
  );
};
